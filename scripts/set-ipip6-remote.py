...
ipip6_add_cmd_str = "ip link add dev %(dev)s type ip6tnl mode ipip6 local %(local)s remote %(remote)s dev br0"
...
ipip6_def_route_cmd = "ip route add 0.0.0.0/0 dev %(dev)s"
